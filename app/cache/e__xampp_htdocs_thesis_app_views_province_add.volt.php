...
<div id="wrapper">
    ...
    <?php echo $this->tag->form(array('province/add', 'method' => 'post')); ?>
    <div class="form-group">
        ...
        <div class="col-xs-3" >
            ...
            <?php echo $this->tag->selectStatic(array('class' => 'form-control', 'type', array('1' => 'Tỉnh', '2' => 'Thành Phố'))); ?>
        </div>


        <?php echo $this->tag->submitButton(array('Thêm', 'class' => 'btn btn-info', 'name' => 'add')); ?>
    </div>
